...
/**
* FUNCTION: leq( out, x, y, clbk )
*	Computes an element-wise comparison (less than or equal to) of an array using an accessor.
*
...
* @returns {Array} array of 1s and 0s, where a `1` indicates that an input array element is less than or equal to a compared value and `0` indicates that an input array element is greater than a compared value
*/
function leq( out, arr, y, clbk ) {
	var len = arr.length,
			i,
			arrVal, yVal;
